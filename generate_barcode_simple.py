    ...
    def draw_labels(self, codes, encoder, label_height, label_width,
        ...
        for i, code in enumerate(codes):
            ...
            encoded = barcode.createBarcodeDrawing(encoder,
                                                   **dict(value=code,
                                                          height=(label_height - height) * 0.88,
                                                          width=label_width))
...
def main():
    ...
    parser.add_argument('-e', '--encoder',      default='Code128')
    parser.add_argument('-le', '--list-encoders', dest='le', 
                        action='store_true', default=False)
    parser.add_argument('-lr', '--list-recipes', dest='lr', 
                        action='store_true', default=False)
    ...
    pdf.draw_labels(codes, args.encoder, **recipe)
    pdf.showPage()
    pdf.save()
